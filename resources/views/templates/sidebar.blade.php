...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    <a href="index.html" class="w-full">
        <span class="flex flex-col justify-center items-center text-blue-500"><span class="text-2xl">Wisesa</span> <span class="font-bold">Job Management</span></span>
      {{-- <img src="{{asset('images/cpp.png')}}" width="100" alt="Logo" /> --}}
    </a>
